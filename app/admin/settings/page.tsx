  ...
  return (
    <>
      ...
      <form className="admin-form">
        ...
        <section className="form-card"><div className="form-card-heading"><div><h2>Inventory defaults</h2><p>Control initial location and low-stock behavior.</p></div></div><div className="form-grid two-columns"><label>Default location code<input defaultValue="MAIN" /></label><label>Default reorder point<input type="number" defaultValue="0" /></label></div><div className="checkbox-row"><label><input type="checkbox" defaultChecked /> Prevent sale below available quantity</label><label><input type="checkbox" defaultChecked /> Show low-stock warnings</label></div></section>
